...
class VAE(nn.Module):
    ...
    def encode(self, x,gate):
        ...
        deout3 = self.deconv_seq3(torch.cat((self.convt3(deout2),self.convt3(feat_down4)),1))
        ...
        deout4 = self.deconv_seq4(torch.cat((self.convt4(deout3),self.convt4(feat_down2)),1))
