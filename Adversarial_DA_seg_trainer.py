...
a = torch.randn((1,12,158,158))
b1 = nn.MaxPool2d(kernel_size=4,stride=4)
b = nn.Conv2d(12,3,kernel_size=3,padding=1)
a_ = b(a)
print(a_.size())
...
#
# def ADA_Train( Train_LoaderA,Train_LoaderB,encoder,decoderA,decoderAdown2,decoderAdown4,decoderB,decoderBdown2,decoderBdown4,gate,DistanceNet,lr,kldlamda,predlamda,dislamda,dislamdadown2,dislamdadown4,epoch,optim, savedir):
#     lr=lr*(0.9**(epoch))
...
#             ADA_Train( SourceData_loader,TargetData_loader,vaeencoder,source_vaedecoder,source_down2_vaedecoder,source_down4_vaedecoder,target_vaedecoder,target_down2_vaedecoder,target_down4_vaedecoder,1.0,DistanceNet,LR,KLDLamda,PredLamda,DisLamda,DisLamdaDown2,DisLamdaDown4,epoch,DA_optim, SAVE_DIR)
#             vaeencoder.eval()
