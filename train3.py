...
def main(args):
    ...
    for sample_num in sample_nums:
        ...
        DistanceNet = Gaussian_Distance(args.kernel)  # 64,Num_Feature2,(12,12)
        ...
        for epoch in range(args.epoch):
            ...
            #     source_MINE.train()
            #     target_MINE.train()
            ADA_Train(SourceData_loader,TargetData_loader,vaeencoder,source_vaedecoder,source_down2_vaedecoder,source_down4_vaedecoder,target_vaedecoder,target_down2_vaedecoder,target_down4_vaedecoder,1.0,DistanceNet,args.lr,args.kldLambda,PredLamda,DisLamda,DisLamdaDown2,DisLamdaDown4,epoch,DA_optim,SAVE_DIR)
